...
- **文档归一重编号**：桌面工作区 36 个编号文档 + Documents 版本归一为 docs/ 01-39 全局唯一编号（主题分段：01-05 总览、06-15 实验、16-26 源码证据、27-36 投稿互动、37-39 预案），无交叉。
- **归档**：源仓库 14 个研究 issue 全文（archive/issues/）、8 个 PR 索引（archive/prs/）、issue 正文草稿演进（archive/issue-body-history/）、早期文档形态（archive/legacy/）。
