...
| 日期 | 主题 | 级别 | 入口 |
| --- | --- | --- | --- |
| 2026-08-21 | WSL/Docker 安全重启 SOP + doctor 宿主残留检查（固化排查链路，查重完成不新开 issue） | P1 | [查看记录](2026-08-21-wsl-docker-restart-sop/README.md) |
| 2026-08-21 | WSL/Docker 僵尸进程锁 vhdx 识别 + 系统服务卡死处置边界（崩溃重启清场） | P1 | [查看记录](2026-08-21-wsl-zombie-lock-host-restart/README.md) |
