...
3. 按任务类型读包内对应文件：`docs/` 专题、源码、`change-history/`。
...
| 任务 | 必读 |
| --- | --- |
| 理解项目 / 架构 | CONTEXT_PACK.md、docs/overview/、docs/INDEX.md |
| 写代码 / 审查代码 | CONTEXT_PACK.md、docs/agents/PRINCIPLES.md、对应专题、相关源码 |
| 写文档 / 设计方案 | CONTEXT_PACK.md、docs/agents/WORKFLOW.md（了解落地流程）、对应专题 |
| 排查行为问题 | CONTEXT_PACK.md、docs/operations/TROUBLESHOOTING.md、对应专题 |
