...
2. 检查 scale-up cooldown、maxReplicas、maxScaleUpBatch（单次扩容步长，0=默认 10）、Policy 和 WorkerNode 资源；任一 WorkerNode 的 PhysicalPressure=True 时停止扩容（Orchestrator ResourceLimited 降级），水位恢复后自动继续。
