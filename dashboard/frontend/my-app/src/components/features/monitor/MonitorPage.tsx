    ...
    return (
        <div className="relative h-full overflow-auto bg-[#05070A] text-[#E8EEF7]">
            ...
            <main className="relative mx-auto flex h-full min-h-0 w-full max-w-[1500px] flex-col px-5 py-6 lg:px-8 lg:py-8">
                ...
                {grafanaState === 'unavailable' && (
                    <div className="mt-4 flex items-start gap-2 rounded-lg border border-amber-300/10 bg-amber-300/[0.035] px-3 py-2 text-[13px] leading-4 text-amber-100/75">
                ...
                <div className="mt-4">
                    <CollapsibleSection
                        title="Grafana 综合视图"
                        subtitle="Grafana 统一视图 · Prometheus 指标与 Jaeger 链路单入口"
                    >
                        <div className="relative min-h-[420px] min-w-0 overflow-hidden rounded-xl border border-white/[0.07] bg-[#0A0E15]/90">
                            <iframe
                                key={reloadKey}
